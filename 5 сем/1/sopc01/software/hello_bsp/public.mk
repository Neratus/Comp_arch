...
SOPCINFO_FILE := C:/user/sopc01/nios.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x9048
SOPC_SYSID_FLAG += --sidp=0x9048
ELF_PATCH_FLAG  += --sidp 0x9048

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1757498345
SOPC_SYSID_FLAG += --timestamp=1757498345
ELF_PATCH_FLAG  += --timestamp 1757498345
